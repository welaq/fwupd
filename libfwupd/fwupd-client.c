...
/**
 * fwupd_client_modify_verbose
 * @client: A #FwupdClient
 * @enable: Gboolean of turning on/off
 * @cancellable: the #GCancellable, or %NULL
 * @error: the #GError, or %NULL
 *
 * Modified daemon verbose debugging
 ...
 **/
gboolean
fwupd_client_modify_verbose (FwupdClient *client, gboolean enable,
			     GCancellable *cancellable, GError **error)
{
	FwupdClientPrivate *priv = GET_PRIVATE (client);
